...
Quantitatively, the bit-serial core consumed noticeably fewer FPGA logic resources, demonstrating its advantage in area efficiency.  
...
Across multiple builds and reconfigurations, the same functional results were obtained, validating the robustness of the hardware-in-the-loop approach.  
Stress tests further demonstrated that the system remained operational under extended workloads without functional degradation.  
