...
Through systematic FPGA prototyping and functional testing, it confirmed the viability of simplified, low-resource architectures operating under strict I/O and design constraints representative of SoI and SiC environments.  

The research contributes by demonstrating that bit-serial RISC-V architectures can maintain functional reliability when verified using a modular hardware testbench.  
The dual-FPGA hardware-in-the-loop validation approach efficiently bridges the gap between simulation and physical testing.  

The project also provides a reusable verification methodology for future high-temperature processor research.  
Once validated, the same testbench can be adapted for post-fabrication silicon evaluation, ensuring continuity across development phases.  
Future work will focus on incorporating thermal-aware modeling, SoI-level implementation, and co-emulation with instruction-set simulators, advancing the development of resilient computing systems for extreme planetary environments.
