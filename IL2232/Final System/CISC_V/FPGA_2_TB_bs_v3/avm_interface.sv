module avm_interface (
    ...
    wire   link_active = com_enable & m_active;
    ...
    // =====================================================
    assign avm_instr_read     = link_active & ~we;          // fetch when CPU is reading
    ...
    assign avm_data_write = link_active & we;
    assign avm_data_read  = link_active & ~we;
